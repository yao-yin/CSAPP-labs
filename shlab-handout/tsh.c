...
struct job_t foreground_jobs[MAXJOBS]; /*foreground job list */
struct job_t background_jobs[MAXJOBS]; /*background job list */
/* Function prototypes */
int foreground_jobs_num = 0; /* number of foreground jobs */
int background_jobs_num = 0; /* number of background jobs */
